...
export function DashboardSidebar({ role }: DashboardSidebarProps) {
  ...
  return (
    <aside className="hidden h-screen w-[300px] shrink-0 flex-col border-r border-white/10 bg-[linear-gradient(155deg,#061325_0%,#102a46_58%,#0a4f56_100%)] p-5 text-white lg:flex">
      ...
      <div className="mt-auto rounded-3xl border border-white/20 bg-white/8 p-4 backdrop-blur">
